...
export async function configExists(changelogDir) {
    try {
...
export async function loadConfig(changelogDir) {
    try {
...
export async function writeConfig(changelogDir, config) {
 ...
 */
export async function findProject(startDir = process.cwd()) {
...
export async function entryDirOf(project) {
    return path.join(project.changelogDir, project.config.entryDir);
}
export async function outDirOf(project) {

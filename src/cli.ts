#!/usr/bin/env node
/**
 * changelog — reusable changelog CLI.
 *
 * Commands:
 *   init    Scaffold the changelog folder structure in a repository.
 *   add     Scaffold a new entry file.
 *   list    List entries.
 *   build   Generate CHANGELOG.md, changelog.json and the end-user page.
...
function str(flags: Flags, name: string, fallback = ''): string {

/**
 * Rendering a changelog document to human-readable Markdown.
 */
import type { ChangelogEntry, ChangelogDocument } from './types.js';
...
function badge(entry: ChangelogEntry): string {
...
export function renderMarkdown(document: ChangelogDocument): string {
  const lines: string[] = [];
